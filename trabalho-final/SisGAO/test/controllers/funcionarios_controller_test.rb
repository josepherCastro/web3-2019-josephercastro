...
class FuncionariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create funcionario" do
    assert_difference('Funcionario.count') do
      post funcionarios_url, params: { funcionario: { cargo: @funcionario.cargo, matricula: @funcionario.matricula, nome: @funcionario.nome, setor: @funcionario.setor } }
    end
  ...
  test "should update funcionario" do
    patch funcionario_url(@funcionario), params: { funcionario: { cargo: @funcionario.cargo, matricula: @funcionario.matricula, nome: @funcionario.nome, setor: @funcionario.setor } }
