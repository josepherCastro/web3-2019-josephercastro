...
class DevolucaosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create devolucao" do
    assert_difference('Devolucao.count') do
      post devolucaos_url, params: { devolucao: { Retirada_id: @devolucao.Retirada_id, quantidade: @devolucao.quantidade } }
    end
  ...
  test "should update devolucao" do
    patch devolucao_url(@devolucao), params: { devolucao: { Retirada_id: @devolucao.Retirada_id, quantidade: @devolucao.quantidade } }
