...
class FornecedorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fornecedor" do
    assert_difference('Fornecedor.count') do
      post fornecedors_url, params: { fornecedor: { cnpj: @fornecedor.cnpj, email: @fornecedor.email, endereco: @fornecedor.endereco, nome: @fornecedor.nome, telefone: @fornecedor.telefone } }
    end
  ...
  test "should update fornecedor" do
    patch fornecedor_url(@fornecedor), params: { fornecedor: { cnpj: @fornecedor.cnpj, email: @fornecedor.email, endereco: @fornecedor.endereco, nome: @fornecedor.nome, telefone: @fornecedor.telefone } }
